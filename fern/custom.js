...
(function loadImageRegistry() {
  ...
  const IMAGES = {
    ...
    "prompts.createBranch": `${S3_BASE}/prompts:create-branch.png`,
    "prompts.branchSelector": `${S3_BASE}/prompts:branch-selector.png`,
    "prompts.branchActions": `${S3_BASE}/prompts:branch-actions.png`,
    "prompts.createPullRequest": `${S3_BASE}/prompts:create-pull-request.png`,
    "prompts.pullRequestGeneral": `${S3_BASE}/prompts:pull-request-general.png`,
    "prompts.pullRequestCommits": `${S3_BASE}/prompts:pull-request-commits.png`,
    "prompts.pullRequestChanges": `${S3_BASE}/prompts:pull-request-changes.png`,
    "prompts.mergePullRequest": `${S3_BASE}/prompts:merge-pull-request.png`,
    "prompts.evalActionsQualityChecks": `${S3_BASE}/prompts:eval-actions-quality-checks.png`,
    "prompts.createEvalTask": `${S3_BASE}/prompts:create-eval-task.png`,
    "prompts.evalTaskTriggers": `${S3_BASE}/prompts:eval-task-triggers.png`,
    "prompts.prEvalChecks": `${S3_BASE}/prompts:pr-eval-checks.png`,
    ...
    "settings.project.aiConnectionAsyncResponses": `${S3_BASE}/ai-connections:async-responses.png`,
