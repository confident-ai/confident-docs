...
![Organization API Key](https://confident-docs.s3.us-east-1.amazonaws.com/confident-docs:organization-auth.png)
</Frame>
...
<Frame caption="Project Settings Page">
![Project API Key](https://confident-docs.s3.us-east-1.amazonaws.com/confident-docs:project-auth.png)
</Frame>
