...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/docs/api-reference/api-conventions"
  >
...
<CardGroup cols={3}>
  <Card
    ...
    icon="chart-line"
    iconType="solid"
    href="/docs/api-reference/metrics/get-custom-metric"
  >
  ...
  <Card
    ...
    icon="flask"
    iconType="solid"
    href="/docs/api-reference/evaluate/evaluate-llm"
  >
    <div className='card-link-icon'>
      <Icon icon="arrow-up-right-from-square" />
    </div>
  ...
  <Card
    ...
    icon="route"
    iconType="solid"
    href="/docs/api-reference/traces/get-trace"
  >
    <div className='card-link-icon'>
      <Icon icon="arrow-up-right-from-square" />
    </div>
  ...
  <Card
    ...
    icon="pen-to-square"
    iconType="solid"
    href="/docs/api-reference/prompts/list-prompts"
  >
    <div className='card-link-icon'>
      <Icon icon="arrow-up-right-from-square" />
    </div>
