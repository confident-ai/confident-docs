...
Confident AI's Evals API allows you to run online evaluations on test cases, traces, spans, and threads. This 5-minute quickstart will walk you through how to:
...
<Steps>
  ...
  <Step title="Create a Metric Collection">
    A metric collection is a group of metrics used to evaluate your test cases. It can either consist of single-turn or multi-turn metrics but not both. Learn more about [metric collections here](/docs/metrics/metric-collections).
