...
- **A [dataset](/docs/llm-evaluation/core-concepts/test-cases-goldens-datasets) of goldens** — what you want to test your MCP agent on.
- **An [AI Connection](/docs/settings/project/ai-connections)** — pointed at your deployed MCP host. Confident AI uses it to run the agent and capture the generated output, tool calls, and tool arguments.
...
<Step title="View your MCP eval results">
...
- **[MCP Use](https://deepeval.com/docs/metrics-mcp-use)** — the default. It scores tool selection and argument quality using the connected server's tool definitions, with no labels required.
...
<AccordionGroup>
  ...
  <Accordion title="Can I measure tool usage without ground truth?">
    ...
    selection and argument correctness using the connected server's tool
