---
subtitle: Learn how domain experts can contribute to AI testing
...
- [Annotate datasets](/docs/llm-evaluation/dataset-management/manage-datasets)
...
<CardGroup cols={2}>
  <Card
    ...
    icon="users"
    iconType="solid"
    href="/docs/human-in-the-loop/collect-feedback"
  >
  ...
  >
    ...
    - Optionally fed by [auto-ingestion](/docs/human-in-the-loop/annotation-queues#auto-ingestion) from production filters
