...
Use this to give Claude Code, Codex, Cursor, and other coding agents the same policy-specific instructions your teams are expected to follow. See [Standardize Onboarding with Custom Agent Skills](/docs/guides/agent-skills-git-endpoint) for the end-to-end setup.
