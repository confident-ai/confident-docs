...
<Warning>
**Corporate laptop restrictions:** Many organizations restrict software installation on managed devices. If you can't install these tools locally, consider:
- Using a cloud-based VM (EC2 instance) as your deployment workstation
- Requesting exceptions from your IT security team
- Using pre-approved container images that include these tools
</Warning>
...
If your organization requires pre-approved IAM policies, work with your cloud security team to get the necessary permissions before proceeding. The [Requirements](/on-prem/aws/requirements) page lists the specific AWS services used.
</Warning>
...
|------------|------------------|
| `confident-terraform` | Terraform code that creates all AWS infrastructure (VPC, EKS, RDS, S3, etc.) |
...
Once you have all prerequisites in place, proceed to [Configuration](/on-prem/aws/configuration) to set up your Terraform variables.
