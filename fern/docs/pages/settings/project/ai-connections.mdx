...
For streaming endpoints, see [Streaming](/docs/settings/project/ai-connections/streaming) to configure chunk formats, SSE event names, and accumulate mode. For agents that take minutes or hours to respond, see [Async Responses](/docs/settings/project/ai-connections/async-responses) to acknowledge each request immediately and post results back later.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/docs/settings/project/ai-connections/async-responses"
  >
    Evaluate long-running agents by acknowledging each request and posting
    results back later.
  </Card>
  <Card
    title="Authorization"
