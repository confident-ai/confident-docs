...
<Card title="Air-Gapped Environments" icon="fa-light fa-shield-halved" href="/docs/guides/confident-agent-air-gapped">
  Running in an air-gapped or egress-restricted network? Follow the [air-gapped setup guide](/docs/guides/confident-agent-air-gapped) to distribute the image and configure outbound WSS allowlisting.
</Card>
