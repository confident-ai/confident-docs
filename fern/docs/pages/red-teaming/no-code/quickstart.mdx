...
<Tip>
Your AI app can be any application reachable over the internet — Confident AI communicates with it directly through your configured AI Connection, meaning no changes to your codebase are required.
</Tip>
...
<Steps>
    ...
    <Step title="Create a Red Teaming Framework">
        ...
        You can choose from various safety frameworks like **OWASP, MITRE, NIST**. Alternatively, you can alsp create a fully custom framework with your own vulnerabilities and attack configurations.
