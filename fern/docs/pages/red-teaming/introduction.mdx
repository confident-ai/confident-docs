...
- [Trace-Level Detections](/docs/red-teaming/trace-level-detections) — surface vulnerabilities at the span level when red-teaming a traced application
