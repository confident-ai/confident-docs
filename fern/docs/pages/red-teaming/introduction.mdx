...
Run risk assessments in the UI without any code or use `deepteam` programatically:
...
<CardGroup cols={2}>
  ...
  >
    ...
    - No code risk assessments
    - Custom red teaming framework curation on the UI

    **Best for:** Non-technical team testing AI for security and compliance.
  </Card>
  <Card
    title="Code-Driven Assessments"
    icon="code"
    iconType="solid"
    href="/docs/red-teaming/code-driven-assessments/quickstart"
  >
    <div className='card-link-icon'>
      <Icon icon="arrow-up-right-from-square" />
    </div>

    - Code-based risk assessments using `deepteam`
    - Custom vulnerabilities and attacks development

    **Best for:** Engineering / Development team iterating on AI for better safety and compliance 
