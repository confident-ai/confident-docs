...
<Tabs>
  <Tab title="AI Connections">
    ...
    - [Linking test cases to traces (single-turn)](/docs/settings/project/ai-connections#linking-test-cases-to-traces)
    - [Linking turns to traces (multi-turn)](/docs/settings/project/ai-connections#linking-turns-to-traces)
  </Tab>
