...
<div data-cta="framework-policies" />
...
Once you're done curating your risk assessment frameworks, Confident AI allows you to schedule automated risk assessments on these frameworks through the UI. Here's how you can schedule an automated risk assessment:

<Steps>

  <Step title="Choose a Framework">
    1. Navigate to the **Frameworks** tab in the sidebar
    2. Choose any framework you wish to schedule risk assessments for

    You'll be redirected to the framework configuration page where you can review and edit your framework.
  </Step>
  <Step title="Create a Schedule">
    1. Navigate to the **Automations** tab at the top of the page.
    2. Click **Add Schedule** and choose your configuration
    3. Click **Create Schedule**. 

    <Frame caption="Creating a red teaming schedule on Confident AI">
        <img data-image="redTeaming.scheduledRedTeamFramework" src="data:" />
    </Frame>
    
    This will now create a schedule with a specified configuration and run the risk assessment on the same configuration at every X interval you've specified in the configuration.
  </Step>
