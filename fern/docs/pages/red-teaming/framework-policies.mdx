...
<Steps>
    <Step title="Create a Red Teaming Framework">
        ...
        <Frame caption="Choosing a red teaming framework">
            <img
    ...
    <Step title="Running a Risk Assessment">
        ...
        3. Select the risk categories you want to test
        4. Choose your AI exposure level and click **Save**

        This will prompt Confident AI to run a risk assessment on your AI application with the chosen config and redirects you to risk profile page.
    </Step>
</Steps>
...
<Steps>
    ...
    <Step title="Creating Risk Categories">
        ...
        2. Select your vulnerability, vulnerability types and set their priority levels
        3. Scroll to the bottom and add any attack methods as you prefer
        4. Click **Save changes**

        You can add as many risk categories as you'd like and create your own custom red teaming framework.
    </Step>

    <Step title="Running a Risk Assessment">

        You can now click on the **Run Assessment** button to run a risk assessment on your AI application with your custom defined red teaming framework and risk categories.
