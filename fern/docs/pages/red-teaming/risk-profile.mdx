...
<Tip>
  If your AI application is traced and linked to test cases, Confident AI also
  scans every span in each trace for vulnerability findings. See [Trace-Level
  Detections](/docs/red-teaming/trace-level-detections) to learn how to set
  that up.
</Tip>
