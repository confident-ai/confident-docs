...
<CardGroup cols={2}>
  <Card
    title="OpenAI"
    icon={
      <img data-image="logos.openai" alt="OpenAI logo" />
    }
  ...
  <Card
    title="LangChain"
    icon={
      <img data-image="logos.langchain" alt="LangChain logo" />
    }
  ...
  <Card
    title="Pydantic AI"
    icon={
      <img data-image="logos.pydantic" alt="Pydantic AI logo" />
    }
  ...
  <Card
    title="LangGraph"
    icon={
      <img data-image="logos.langgraph" alt="LangGraph logo" />
    }
  ...
  <Card
    title="LlamaIndex"
    icon={
      <img data-image="logos.llamaindex" alt="LlamaIndex logo" />
    }
  ...
  <Card
    title="Crew AI"
    icon={
      <img data-image="logos.crewai" alt="Crew AI logo" />
    }
...
<CardGroup cols={2}>
  <Card
    title="Portkey"
    icon={
      <img data-image="logos.portkey" alt="Portkey logo" />
    }
  ...
  <Card
    title="LiteLLM"
    icon={
      <img data-image="logos.portkey" alt="LiteLLM logo" />
    }
