...
[LangChain](https://www.langchain.com/) is a framework for building LLM applications. Confident AI provides a callback handlers in both python and typescript SDKs to trace and evaluate your LangChain applications automatically.
...
<Note>
  Logging prompts lets you attribute specific prompts to LangChain LLM spans.
...
Create a metric collection on [Confident AI](https://app.confident.ai) with the metrics you wish to use to evaluate your LangChain application. Copy the name of the metric collection.
