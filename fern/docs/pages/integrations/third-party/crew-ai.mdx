...
To run [online evals](https://documentation.confident-ai.com/docs/llm-tracing/evaluations) on your CrewAI agent, replace your CrewAI `Agent` with DeepEval’s, and provide a metric collection name as an argument to the `Agent`.
