...
You can run [online evals](/docs/llm-tracing/evaluations) on your Portkey LLM calls, which will run evaluations on all incoming traces on Confident AI’s servers. This approach is recommended if your application is in production.
