---
subtitle: LLM Tracing Name
slug: llm-tracing/advanced-features/name
description: Learn about name in LLM Tracing
---

oth traces and spans have names, and you can customize them based on your liking for better UI display.
