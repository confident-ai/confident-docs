---
subtitle: LLM Tracing Threads
slug: llm-tracing/advanced-features/threads
description: Learn about threads in LLM Tracing
---
...
<Callout>It is traces that are grouped together, not spans.</Callout>
...
<Callout>
  If the I/O is not provided, it will be set to the [default I/O values of the
  trace.](/docs/llm-tracing/tracing-features/input-output#set-trace-io-at-runtime)
</Callout>
