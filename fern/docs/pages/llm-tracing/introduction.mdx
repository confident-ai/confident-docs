...
If you use **Claude Code**, install Confident AI's plugin and Claude will instrument your app for you — picking the right path (DeepEval `@observe`, a framework integration, or OpenTelemetry) based on what your project uses and what you ask.
...
The `/plugins` command should list `deepeval` under your installed plugins.

</Step>

<Step title="Ask Claude to instrument your app">

Open the project you want to trace and tell Claude what you need. Example prompts:
...
Claude will read the codebase, choose between a native integration and manual `@observe`, and confirm traces land in the Observatory.
