...
| **Third-party integrations**                                 | Auto-instrument popular frameworks ([OpenAI](/docs/integrations/third-party/openai), [LangChain](/docs/integrations/third-party/langchain), [Pydantic AI](/docs/integrations/third-party/pydantic-ai), [Vercel AI SDK](/docs/integrations/third-party/vercel-ai-sdk), etc.) | Python and/or Typescript                   |
...
<CardGroup cols={2}>
  ...
  <Card title="Signals" icon="signal-stream" href="/docs/llm-tracing/features/signals">
    Auto-classify traces and threads with LLM-driven labels you define, and
    surface spikes, breakdowns, and trends.
  </Card>
</CardGroup>
