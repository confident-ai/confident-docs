...
The **Evaluations** tab exposes two project-wide sample rates that control what fraction of your ingested data is automatically evaluated:
...
<Frame caption="Trace sample rate on the Evaluations tab under Traces">
  <img data-image="tracing.workflows.sampleRates" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" />
</Frame>
