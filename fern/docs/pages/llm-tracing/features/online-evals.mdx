...
<Tip>
  ...
  Rules](/docs/settings/project/evaluation-rules) in Project Settings to
...
```typescript title="index.ts" {4,10} maxLines={0}
...
```typescript title="index.ts" {7} maxLines={0}
