---
slug: self-hosting
description: Deploy Confident AI in your own infrastructure with self-hosted deployment options
---
...
On-premise deployments are only available for customers with Enterprise lisences. [Talk to us](https://www.confident-ai.com/book-a-demo) to inquire about one.
...
<CardGroup cols={3}>
  <Card
    ...
    href="/self-hosting/aws/introduction"
  >
  ...
  <Card
    ...
    href="/self-hosting/azure/introduction"
  >
  ...
  <Card
    ...
    href="/self-hosting/gcp/introduction"
  >
...
<Note>
  For fully air-gapped deployments without any outbound access, contact
  Confident AI for offline image delivery and self-hosted LLM evaluation
  options.
</Note>
...
<Warning>
  Common delays: permission requests stuck in approval queues, DNS changes
  requiring change tickets, security reviews for VPC peering or firewall rules.
</Warning>
...
1. Contact Confident AI [here](https://www.confident-ai.com/book-a-demo) or, for existing users in your private support channel, to discuss your requirements and obtain an Enterprise license
