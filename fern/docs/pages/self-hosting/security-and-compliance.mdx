...
| **Service accounts** | Cloud-native IAM for service-to-service authentication (EKS Pod Identity, Workload Identity, etc.) |
...
- [Azure Deployment](/self-hosting/azure/overview)
