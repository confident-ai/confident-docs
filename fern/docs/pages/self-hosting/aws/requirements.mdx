...
| ------------------- | ---------------------------------- | ---------------------------------- |
| **EKS Nodes**       | 4x `m6i.2xlarge` (8 vCPU, 32GB)   | 4x `m6i.2xlarge` (8 vCPU, 32GB)   |
| **EKS Autoscaling** | 2-8 nodes                          | 2-8 nodes                          |
| **RDS Instance**    | `db.t4g.large` (2 vCPU, 8GB)      | `db.t4g.large` (2 vCPU, 8GB)      |
| **RDS Storage**     | 20GB (max 100GB)                   | 20GB (max 100GB)                   |
...
| **IAM**             | Roles and policies for EKS Pod Identity      | Grants pods specific AWS permissions |
...
| EKS Nodes (EC2)    | $800-1600      | $800-1600       |
| RDS Instance       | $100           | $100            |
| NAT Gateway        | $35            | $35             |
| S3 + Data Transfer | ~$10           | $10-50          |
| **Total (approx)** | **$1000-1800** | **$1000-1900**  |
