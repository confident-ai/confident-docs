...
After the certificate is validated and issued, proceed to [Cluster Access](/self-hosting/aws/cluster-access) to configure kubectl access to your EKS cluster.
