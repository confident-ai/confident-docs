...
The variables you are most likely to set. For the complete, always-current list, see the [module inputs on the Terraform Registry](https://registry.terraform.io/modules/confident-ai/confident-ai/google/latest?tab=inputs).
