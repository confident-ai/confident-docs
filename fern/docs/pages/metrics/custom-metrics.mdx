...
Running custom metrics locally gives you code-level control over your metrics, but they are only limited to python users using `deepeval` and is not available for on/offline evals in production.
