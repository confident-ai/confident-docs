...
The answer relevancy metric uses LLM-as-a-judge to assess whether your RAG generator's output is relevant to the given input. It is a single-turn metric designed specifically for evaluating RAG-based question-answering, not general RAG use cases.
