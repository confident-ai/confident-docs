...
The tool correctness metric is a single-turn metric that is used to evaluate your LLM agent's tool calling ability. Unlike the other metrics, tool correctness metric does not use an LLM for evaluation.
