...
[End-to-end evaluation](/docs/llm-evaluation/end-to-end-evals) refers to LLM evaluation where your LLM application is treated as a black-box, and only the system inputs and outputs are taken into account. When running end-to-end evaluations, you should only create test cases from the `input`s, `actual_outputs`s, and any other overarching parameter of your LLM system.
