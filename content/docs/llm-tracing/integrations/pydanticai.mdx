...
**Version Compatibility**: DeepEval's `Agent` (i.e. `from deepeval.integrations.pydantic_ai import Agent`) wrapper requires PydanticAI version **0.4.2** to **0.5.0** (inclusive) to be installed.
</Callout>
