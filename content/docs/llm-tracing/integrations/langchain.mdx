...
Run online evaluation on your Langchain agents by simply providing `metric_collection` as an argument in `CallbackHandler`. This will allow you run [online evaluation](https://documentation.confident-ai.com/docs/llm-tracing/evaluations) in production.

<Callout type="info">
Only **task completion** metric is supported in the [metric collection](https://documentation.confident-ai.com/docs/llm-evaluation/metrics/create-on-the-cloud) for LangChain.
</Callout>
