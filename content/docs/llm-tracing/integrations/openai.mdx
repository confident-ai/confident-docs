...
You can also use DeepEval's OpenAI client to run [component-level evaluations](/docs/llm-evaluation/component-level-evals) locally. To do this, replace your existing `OpenAI` client, pass in `metrics`, and invoke your LLM application under the `dataset` generator.
