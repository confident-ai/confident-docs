...
<Callout type="info">
Only **task completion** metric is supported in the [metric collection](https://documentation.confident-ai.com/docs/llm-evaluation/metrics/create-on-the-cloud) for LangGraph.
</Callout>
...
This will evaluate agent's **root** span with the metric collection.

<Callout>
To know more about **task completion** metric, refer to the [documentation](https://deepeval.com/docs/metrics-task-completion).
</Callout>
