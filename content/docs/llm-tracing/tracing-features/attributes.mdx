...
```typescript filename="index.ts" showLineNumbers {12}
...
<Tabs items={['Python', 'JS/TypeScript']}>
  <Tabs.Tab>
    ```python filename="main.py" showLineNumbers copy {7}
...
```typescript filename="index.ts" showLineNumbers copy {5}
...
<Tabs items={['Python', 'JS/TypeScript']}>
  <Tabs.Tab>
    ```python filename="main.py" showLineNumbers copy {6}
